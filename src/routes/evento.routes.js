...
router.post('/', requireAuth, checkAdmin, parseConvocatorias, validate(createEventoSchema), EventoController.create)
router.post('/:id/convocatorias', requireAuth, checkAdmin, validate(addConvocatoriaSchema), EventoController.addConvocatoria)
router.put('/:id/fecha-cierre',   requireAuth, checkAdmin, validate(updateFechaCierreSchema), EventoController.updateFechaCierre)
